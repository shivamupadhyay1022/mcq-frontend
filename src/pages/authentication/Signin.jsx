...
function Signin() {
  ...
  return (
    <div className="font-hind flex flex-col justify-center ">
      ...
      {/* contents */}
      <div className="bg-slate-800  border-r-8 mt-20 rounded-r-[50px] border-gray-800 h-fit  overflow-y-hidden">
        ...
        By creating an account I accept the Company’s Terms of Use and Privacy Policy
        </span>
        </div>
      </div>
    </div>
